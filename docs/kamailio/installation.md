...
```c
{% include "./_etc_haproxy/haproxy.cfg" %}
```
...
### `/etc/kamailio/routes/trunks.cfg`
```c
{% include "./_etc_kamailio/routes/trunks.cfg" %}
```

### `/etc/kamailio/routes/iap.cfg`
```c
{% include "./_etc_kamailio/routes/iap.cfg" %}
```

### `/etc/kamailio/routes/register.cfg`
```c
{% include "./_etc_kamailio/routes/register.cfg" %}
```

### `/etc/kamailio/routes/inbound.cfg`
```c
{% include "./_etc_kamailio/routes/inbound.cfg" %}
```

### `/etc/kamailio/routes/outbound.cfg`
```c
{% include "./_etc_kamailio/routes/outbound.cfg" %}
```

### `/etc/kamailio/routes/ws.cfg`
```c
{% include "./_etc_kamailio/routes/ws.cfg" %}
```
